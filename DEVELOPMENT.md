...
```bash
git remote add encore encore://talent-manager-app-iv22
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/talent-manager-app-iv22/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/talent-manager-app-iv22/settings/integrations/github)
